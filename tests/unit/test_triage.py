...
class TestTriageRouter:
    ...
    def test_boost_patterns(self):
        ...
        router = TriageRouter(llm_client=None)
        base = {"domain_complexity": 2, "timeliness": 2, "depth_required": 2,
    ...
    def test_privacy_override(self):
        ...
        router = TriageRouter(llm_client=None)
        scores = {"domain_complexity": 5, "timeliness": 5, "depth_required": 5,
                  "multi_source": 5, "privacy_sensitivity": 4}
    ...
    async def test_llm_classify_mock(self):
        ...
        mock_client.generate.return_value = (
            '{"domain_complexity": 3, "timeliness": 2, "depth_required": 4, '
