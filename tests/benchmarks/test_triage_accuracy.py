...
LABELED_QUERIES = [
    ...
    ("Analyze the evolution of transformer architecture from 2017 to 2025.", "L2", "deep tech evolution"),
    ("What is the current state of MoE models in production?", "L2", "production MoE"),
    ("How do different LLM quantization methods compare in accuracy vs speed?", "L2", "quantization comparison"),
    ("Investigate the environmental impact of training large AI models.", "L2", "environmental impact"),

    # L3: Counter-arguments, academic depth
    ("Are large language models actually understanding or just pattern matching? Analyze both sides.", "L3", "understanding debate"),
    ("Evaluate the evidence for and against AI existential risk.", "L3", "existential risk debate"),
    ("Is open-source AI more secure than closed-source? Provide academic evidence.", "L3", "open vs closed security"),

    # L4: Multi-perspective, requires voting
    ("What will be the most impactful AI breakthrough in the next decade? Consider multiple expert perspectives.", "L4", "future prediction debate"),
    ("Synthesize the complete history and future trajectory of AI alignment research.", "L4", "alignment synthesis"),
    ("How should governments regulate frontier AI models? Present a balanced multi-stakeholder analysis.", "L4", "regulation multi-stakeholder"),
]
