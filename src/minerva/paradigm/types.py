...
PARADIGMS: dict[ResearchParadigm, ParadigmDefinition] = {
    ResearchParadigm.SCIENTIFIC_INQUIRY: ParadigmDefinition(
        ...
        description="Hypothesis-driven investigation: formulate hypothesis, gather evidence from multiple sources, cross-validate claims, verify against counter-evidence, draw conclusion.",
        verification_mode=VerificationMode.STRICT,
        stages=["decompose", "search", "entity_extract", "deep_read", "cross_analyze",
                "counter_argument", "quality_gate", "verify", "output"],
        completion_criteria=[
    ...
    ResearchParadigm.COMPARATIVE_ANALYSIS: ParadigmDefinition(
        ...
        description="Multi-dimensional comparison: define criteria, collect data for each option, build comparison matrix, synthesize trade-offs, provide recommendation with rationale.",
        verification_mode=VerificationMode.STANDARD,
        stages=["decompose_criteria", "search_per_option", "cross_compare", "synthesize",
                "counter_argument", "quality_gate", "output"],
        completion_criteria=[
    ...
    ResearchParadigm.PROBLEM_SOLVING: ParadigmDefinition(
        ...
        description="Structured debugging: define the problem precisely, generate hypotheses, test each against evidence, eliminate failed hypotheses, verify the solution, document the root cause.",
        verification_mode=VerificationMode.STRICT,
        stages=["define_problem", "generate_hypotheses", "search_per_hypothesis",
                "test_hypotheses", "eliminate_failed", "verify_solution", "output"],
        completion_criteria=[
    ...
    ResearchParadigm.LITERATURE_REVIEW: ParadigmDefinition(
        ...
        description="Systematic survey: define scope, multi-source collection, taxonomy categorization, cross-source synthesis, gap identification, future directions.",
        verification_mode=VerificationMode.STANDARD,
        stages=["define_scope", "search", "categorize", "synthesize", "identify_gaps",
                "quality_gate", "output"],
        completion_criteria=[
    ...
    ResearchParadigm.POLICY_ANALYSIS: ParadigmDefinition(
        ...
        verification_mode=VerificationMode.STANDARD,
        stages=["establish_context", "map_stakeholders", "search", "analyze_impact",
                "evaluate_alternatives", "counter_argument", "quality_gate", "output"],
        completion_criteria=[
