...
class ContradictionReport:
    ...
    def summary(self) -> str:
        ...
        return (
            ...
            f"across {self.total_reports_scanned} reports "
            f"({self.total_claims_checked} claims checked)."
        )
...
class ContradictionDetector:
    ...
    def __init__(self, llm_client=None, report_dir: str = "~/knowledge/reports"):
        self.llm = llm_client
    ...
    async def _detect_with_llm(
        ...
        claims_text = "\n".join(
            f"{i+1}. [{e['claim'][:200]}] (source: {e['source'][:100]})"
