...
class KnowledgeIngester:
    ...
    def __init__(self, knowledge_store=None, nlp_pipeline=None, report_dir: str = "~/knowledge/ingested"):
    ...
    def _save_markdown(self, source: str, text: str):
