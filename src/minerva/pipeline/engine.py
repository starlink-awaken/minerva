...
def create_default_pipeline(
    ...
    stages = {
        ResearchLevel.L0: [
            MultiSourceSearchStageImpl(search_engine, backends=["ddg", "scholar", "metaso", "exa", "brave"], max_results=5),
            OutputStageImpl(llm_client=llm_client, knowledge_store=knowledge_store),
        ],
        ResearchLevel.L1: [
            DecomposeStageImpl(llm_client, max_sub_questions=5),
            MultiSourceSearchStageImpl(search_engine, backends=["ddg", "scholar", "metaso", "exa", "brave"], max_results=10),
            CrossAnalyzeStageImpl(llm_client),
            OutputStageImpl(llm_client=llm_client, knowledge_store=knowledge_store),
        ],
        ResearchLevel.L2: [
            DecomposeStageImpl(llm_client, max_sub_questions=10),
            MultiSourceSearchStageImpl(search_engine, backends=["ddg", "scholar", "arxiv", "metaso", "exa", "brave"], max_results=25),
